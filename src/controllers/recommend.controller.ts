...
import { RecommendPapersInput } from "../validations/recommended";

const db = new PaperDatabase();

export const recommendPapersController = async (
  input: RecommendPapersInput,
) => {
  const { text, limit = 5, minRelevance = 15 } = input;
